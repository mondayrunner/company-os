/**
 * Wachten met een gezicht.
 *
 * Een spinner die alleen draait zegt niets. Een woord dat verandert, een teller
 * die loopt en af en toe een regel over wat er gebeurt, zegt: ik leef nog, en
 * dit duurt zo lang. De woorden zijn dezelfde als die Claude Code gebruikt —
 * een knipoog, en ze werken omdat ze niets beloven.
 */
