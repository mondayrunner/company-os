  ...
  <div class="h-full overflow-y-auto">
    <div class="max-w-4xl mx-auto px-6 py-10">
      ...
      <p class="text-[11px] text-ink-3 mt-4 leading-relaxed">
        ...
        draft — write one too. Cost shows when the run reported one; jobs that write their own status usually do not. Things that need a decision from you are in the
